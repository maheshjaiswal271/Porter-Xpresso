    ...
    { field: 'scheduledTime', headerName: 'Scheduled Time', flex: 1 },
    {
      ...
      renderCell: (params) => (
        <>
          ...
          <IconButton onClick={() => window.open(`${window.location.origin}/#/track/${params.row.id}`, '_blank')} color="info" title="Track Order">
          ...
          {viewDelivery && (
            <>
              ...
              <Button
                ...
                color="info"
                sx={{ mt: 2 }}
                onClick={() => window.open(`${window.location.origin}/#/track/${viewDelivery.id}`, '_blank')}
