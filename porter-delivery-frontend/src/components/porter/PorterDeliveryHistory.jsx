              ...
              {deliveries
                ...
                .map((delivery) => (
                  <TableRow hover key={delivery.id}>
                    ...
                    <TableCell>
                      {format(new Date(delivery.scheduledTime), 'PPp')}
                    </TableCell>
                    <TableCell>
                      <Chip
        ...
        <DialogContent>
          {selectedDelivery && (
            <Box sx={{ pt: 1 }}>
              ...
              <Typography variant="body2" gutterBottom>
                • Scheduled: {format(new Date(selectedDelivery.scheduledTime), 'PPp')}
              </Typography>
              <Typography variant="body2" gutterBottom>
                • Created: {format(new Date(selectedDelivery.createdAt), 'PPp')}
              </Typography>
              <Typography variant="body2" gutterBottom>
                • Last Updated: {format(new Date(selectedDelivery.updatedAt), 'PPp')}
              </Typography>
