            ...
            <Paper key={b.delivery.id} sx={{ p: 2, mb: 2, background: '#fffbe6', border: '2px solid #ffd700', position: 'relative' }} elevation={4}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="body2">Scheduled: {b.delivery.scheduledTime && format(new Date(b.delivery.scheduledTime), 'PPp')}</Typography>
                  ...
                  secondary={
                    <>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <Chip
                          size="small"
                          label={`Scheduled: ${format(new Date(delivery.scheduledTime), 'PPp')}`}
                          sx={{ mr: 1 }}
                        />
                        <Chip
                          size="small"
        ...
        <DialogContent>
          ...
          {selectedDelivery && (
            <Box sx={{ mt: 2 }}>
              ...
              <Typography variant="body2">
                • Scheduled Time: {format(new Date(selectedDelivery.scheduledTime), 'PPp')}
              </Typography>
            </Box>
          )}
        </DialogContent>
